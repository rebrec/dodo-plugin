...
module.exports = {
  ...
  caption: "Dodo",
  shell: "powershell",
  initCommands: ["$global:DODO_BASE_URL=\"http://#{dodoApiHost}\" + \":\" + \"#{dodoApiPort}/api/script\"", ". #{modulePath}init.ps1"],
  columns: [{
    columnName: 'Hostname',
...
/*#__PURE__*/
function (_Plugin) {
  _inherits(DodoPlugin, _Plugin);

  function DodoPlugin(api, context) {
    var _this;

    _classCallCheck(this, DodoPlugin);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(DodoPlugin).call(this, api, context));
